...
export default function BusinessProfile() {
    ...
    const handleArchiveSubmit = () => {
        ...
        router.delete(`/institutions/business/${archiveTarget.id}`, {
            data: { deleted_reason: archiveReason },
            preserveScroll: true,
            onSuccess: () => { setArchiveTarget(null); setSelectedBusiness(null); },
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
                    <div className="bg-white dark:bg-[#0f172a] w-full max-w-md rounded-2xl shadow-2xl overflow-hidden border border-white/20">
                        <div className="bg-red-950 text-white p-5 flex justify-between items-center">
                            <div>
                                <h2 className="text-lg font-bold flex items-center gap-2"><Trash2 className="size-5 text-red-400" /> Archive Business</h2>
                        ...
                        <div className="p-6 space-y-4">
                            <p className="text-sm text-neutral-600 dark:text-neutral-400">Are you sure you want to move this business to archives?</p>
                                        ...
                                        >
                                            ...
                                            <td className="px-4 py-3 text-right">
                                                <div className="flex flex-col items-end gap-1">
                                                    ...
                                                    <button
                                                        onClick={(e) => handleDelete(e, biz.id, biz.businessName)}
