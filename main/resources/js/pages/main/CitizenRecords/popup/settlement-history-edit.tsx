    ...
    useEffect(() => {
        if (history && isOpen) {
            setData({
                ...
                linked_history_id: history.linked_history_id || '',
                linked_history_details: history.linked_history ? {
                    uuid: history.linked_history.cihi_uuid,
                    title: history.linked_history.title,
                    type: history.linked_history.type,
                    status: history.linked_history.status
                } : null,
